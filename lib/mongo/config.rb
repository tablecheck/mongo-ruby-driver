...
module Mongo
  ...
  module Config
    ...
    # When this flag is set to true, the driver will monitor for process
    # forking based on process ID, and automatically reconnect all clients
    # on the forked process. If you disable this option, please be sure to
    # manually call Client#reconnect on each client after forking.
    option :reconnect_on_pid_change, default: true
